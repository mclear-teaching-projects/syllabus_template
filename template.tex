...
\sectionfont{\rmfamily\scshape\mdseries} 
...
\usepackage{lastpage}
\usepackage{epigraph}
\setlength{\epigraphwidth}{.525\textwidth}
...
\lfoot{\footnotesize \myauthor\ | \myclassnumber}
...
\item \textbf{Grading}: $requirements.grading$
